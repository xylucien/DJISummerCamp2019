...
// this register is only effetive when FCHOICE_B register bits are 2b00,and 0<
// DLPF_CFG <7,more please refer to the datasheet the value can be max 256,means
// 257 div,but usually be 0 (1 div)  in our robots.
